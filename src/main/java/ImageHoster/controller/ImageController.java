...
public class ImageController {
    ...
    public void showImage(String title)//Receive the dynamic variable in the URL '/images/{title}' in a string variable named 'title' and the Model type object named 'model'
                            {
                            Date date =new Date();
